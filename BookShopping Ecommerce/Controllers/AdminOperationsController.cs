...
namespace BookShopping_Ecommerce.Controllers
{
    ...
    public class AdminOperationsController : Controller
    {
        ...
        public async Task<IActionResult> UpdateOrderStatus(int orderId)
        {
            ...
            {
                return new SelectListItem { Value = orderStatus.Id.ToString(), Text = orderStatus.Name, Selected = order.OrderStatusId == orderStatus.Id };
            });
        ...
        public async Task<IActionResult> UpdateOrderStatus(UpdateOrderStatusModel data)
        {
            try
            {
                if (!ModelState.IsValid)
                {
                    ...
                    {
                        return new SelectListItem { Value = orderStatus.Id.ToString(), Text = orderStatus.Name, Selected = orderStatus.Id == data.OrderStatusId };
                    });
